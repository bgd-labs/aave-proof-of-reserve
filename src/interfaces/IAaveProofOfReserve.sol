...
interface IAaveProofOfReserve {
   ...
   * @param proofOfReserveFeed address of the PoR feed
   ...
   * @param user address of the user who inited the action
   */
  event EmergencyActionExecuted(address indexed user);

  /**
   * @dev add assets and corresponding proof of reserve feed to the registry.
   * @param asset address of the asset
   * @param proofOfReserveFeed address of the proof of reserve aggregator feed
   */
  function enableProofOfReserveFeed(address asset, address proofOfReserveFeed)
    external;

  /**
   * @dev delete asset and proof of reserve feed from the registry.
   * @param asset address of the asset
   */
