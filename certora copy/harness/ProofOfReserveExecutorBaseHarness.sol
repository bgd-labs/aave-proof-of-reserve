...
contract ProofOfReserveExecutorBaseHarness is ProofOfReserveExecutorBase {

    constructor(address proofOfReserveAggregatorAddress) ProofOfReserveExecutorBase(proofOfReserveAggregatorAddress) {}
  ...
  /// @inheritdoc IProofOfReserveExecutor
    function isBorrowingEnabledForAtLeastOneAsset() external view override returns (bool) {
        return !_disableBorrowingCalled;
    }
}