...
deploy-executor-v3 :; forge script scripts/DeployExecutorV3Avax.s.sol:Deploy --rpc-url avalanche --broadcast --legacy --ledger --mnemonic-indexes ${MNEMONIC_INDEX} --sender ${LEDGER_SENDER} --verify -vvvv
